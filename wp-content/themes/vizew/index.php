        ...
        <div class="row no-gutters">
            <div class="col-12 col-md-7 col-lg-8">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="post-<?= get_the_ID(); ?>" role="tabpanel" aria-labelledby="post-<?= get_the_ID(); ?>-tab">
                        <!-- Single Feature Post -->
                        <div class="single-feature-post video-post bg-img" style="background-image: url(<?= get_the_post_thumbnail_url(); ?>);">
                            <!-- Play Button -->
                            <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>

                            <!-- Post Content -->
                            <div class="post-content">
                                <a href="#" class="post-cata"><?= get_the_category_list(', ') ?></a>
                    ...
                    <?php while(have_posts()): the_post(); ?>
                        <div class="tab-pane fade" id="post-<?= get_the_ID(); ?>" role="tabpanel" aria-labelledby="post-<?= get_the_ID(); ?>-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(<?= get_the_post_thumbnail_url(); ?>);">
                                <!-- Play Button -->
                                <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                                ...
                                <!-- Post Content -->
                                <div class="post-content">
                                    <a href="#" class="post-cata"><?php get_the_category_list(', ') ?></a>
                                    <a href="single-post.html" class="post-title"><?php  the_title(); ?></a>
                                    <div class="post-meta d-flex">
                                        <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 25</a>
                                        <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 25</a>
            ...
            <div class="col-12 col-md-5 col-lg-4">
                <ul class="nav vizew-nav-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="post-<?= get_the_ID(); ?>-tab" data-toggle="pill" href="#post-<?= get_the_ID(); ?>" role="tab" aria-controls="post-<?= get_the_ID(); ?>" aria-selected="true">
                            <!-- Single Blog Post -->
                    ...
                    <?php while(have_posts()): the_post(); ?>
                        <li class="nav-item">
                            <a class="nav-link" id="post-<?= get_the_ID(); ?>-tab" data-toggle="pill" href="#post-<?= get_the_ID(); ?>" role="tab" aria-controls="post-<?= get_the_ID(); ?>" aria-selected="false">
                                <!-- Single Blog Post -->
                                <div class="single-blog-post style-2 d-flex align-items-center">
                                    <div class="post-thumbnail">
                                        <?php the_post_thumbnail() ?>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="single-post-area mb-80">
                    <!-- Post Thumbnail -->
                    <div class="post-thumbnail">
                        <img src="<?= get_theme_file_uri('img/bg-img/11.jpg') ?>" alt="">
            ...
            <div class="col-12 col-md-4">
                <div class="single-post-area mb-80">
                    <!-- Post Thumbnail -->
                    <div class="post-thumbnail">
                        <img src="<?= get_theme_file_uri('img/bg-img/12.jpg'); ?>" alt="">
            ...
            <div class="col-12 col-md-4">
                <div class="single-post-area mb-80">
                    <!-- Post Thumbnail -->
                    <div class="post-thumbnail">
                        <img src="<?= get_theme_file_uri('img/bg-img/13.jpg') ?>" alt="">
            ...
            <div class="col-12 col-md-7 col-lg-8">
                <div class="all-posts-area">
                    ...
                    <div class="featured-post-slides owl-carousel mb-30">
                        <!-- Single Feature Post -->
                        <div class="single-feature-post video-post bg-img" style="background-image: url(<?= get_theme_file_uri('img/bg-img/14.jpg') ?>);">
                            <!-- Play Button -->
                            <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        ...
                        <!-- Single Feature Post -->
                        <div class="single-feature-post video-post bg-img" style="background-image: url(<?= get_theme_file_uri('img/bg-img/7.jpg') ?>);">
                            <!-- Play Button -->
                            <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="sport-video-slides owl-carousel mb-50">
                                ...
                                <div class="single-post-area">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="<?= get_theme_file_uri('img/bg-img/15.jpg') ?>" alt="">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="business-video-slides owl-carousel mb-50">
                                ...
                                <div class="single-post-area">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="<?= get_theme_file_uri('img/bg-img/17.jpg') ?>" alt="">
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post style-3 d-flex mb-50">
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/16.jpg') ?>" alt="">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post style-3 d-flex mb-50">
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/18.jpg') ?>" alt="">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post style-3 d-flex mb-50">
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/19.jpg') ?>" alt="">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-post style-3 d-flex mb-50">
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/20.jpg') ?>" alt="">
                                </div>
                                <div class="post-content">
                    ...
                    <div class="single-post-area mb-30">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-6">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/21.jpg') ?>" alt="">
                    ...
                    <div class="single-post-area mb-30">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-6">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/22.jpg') ?>" alt="">
                    ...
                    <div class="single-post-area mb-30">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-6">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/23.jpg') ?>" alt="">
                    ...
                    <div class="single-post-area mb-30">
                        <div class="row align-items-center">
                            <div class="col-12 col-lg-6">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="<?= get_theme_file_uri('img/bg-img/24.jpg') ?>" alt="">
                ...
                <div class="sidebar-area">
                    ...
                    <div class="single-widget latest-video-widget mb-50">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/1.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/2.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/35.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                    ...
                    <div class="single-widget add-widget mb-50">
                        <a href="#"><img src="<?= get_theme_file_uri('img/bg-img/add.png') ?>" alt=""></a>
                    </div>
                    ...
                    <div class="single-widget youtube-channel-widget mb-50">
                        ...
                        <div class="single-youtube-channel d-flex align-items-center">
                            <div class="youtube-channel-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/25.jpg') ?>" alt="">
                            </div>
                        ...
                        <div class="single-youtube-channel d-flex align-items-center">
                            <div class="youtube-channel-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/26.jpg') ?>" alt="">
                            </div>
                            <div class="youtube-channel-content">
                        ...
                        <div class="single-youtube-channel d-flex align-items-center">
                            <div class="youtube-channel-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/27.jpg') ?>" alt="">
                            </div>
                            <div class="youtube-channel-content">
                        ...
                        <div class="single-youtube-channel d-flex align-items-center">
                            <div class="youtube-channel-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/28.jpg') ?>" alt="">
                            </div>
                            <div class="youtube-channel-content">
                        ...
                        <div class="single-youtube-channel d-flex align-items-center">
                            <div class="youtube-channel-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/29.jpg') ?>" alt="">
                            </div>
                            <div class="youtube-channel-content">
                    ...
                    <div class="single-widget mb-50">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/36.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/37.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">DC Shoes: gymkhana five; the making of</a>
                                <div class="post-meta d-flex justify-content-between">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?= get_theme_file_uri('img/bg-img/38.jpg') ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">How To Make Orange Chicken Recipe?</a>
                                <div class="post-meta d-flex justify-content-between">
